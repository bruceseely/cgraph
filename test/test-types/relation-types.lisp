...
(:label part  :source-types individual        :dest-type individual      :desc "part - links [INDIVIDUAL] to another [INDIVIDUAL] that is one of its parts")
(:label physical-part :source-types object    :dest-type entity          :desc "physical part - links an [OBJECT] to an [ENTITY] that is one of its parts")
