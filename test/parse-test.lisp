...
(defun parse-test (&optional verbose)
  ...
  (ensure-relation-types-exist
   '((:label agnt :source-types act :dest-type animate)
     ...
     (:label matr :source-types entity :dest-type substance)
     (:label meas :source-types dimension :dest-type measure)
     (:label memb :source-types set :dest-type entity)
     (:label name :source-types entity :dest-type word)
     (:label obj  :source-types act :dest-type entity)
     (:label part :source-types entity :dest-type entity)
